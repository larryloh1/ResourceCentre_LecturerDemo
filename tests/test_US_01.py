...
class Test_US_01:
    ...
    ############### Test view camera ######################
    def test_view_empty_camera_list(self): #all of these test case added to test_US_01.py
        test_inventory = Inventory()
    ...
    def test_view_camera(self): #all of these test case added to test_US_01.py
        test_inventory = Inventory()
        result = test_inventory.addCamera("C001", "Test camera 1", 5)
        result = test_inventory.addCamera("C002", "Test camera 2", 10)
    ...
    def test_view_camera_only_available(self): #all of these test case added to test_US_01.py
        test_inventory = Inventory()
        result = test_inventory.addCamera("C001", "Test camera 1", 5)
        result = test_inventory.addCamera("C002", "Test camera 2", 10)
    ...
    ############### Test view laptop ######################
    def test_view_empty_laptop_list(self): #all of these test case added to test_US_01.py
        test_inventory = Inventory()
    ...
    def test_view_laptop(self): #all of these test case added to test_US_01.py
        test_inventory = Inventory()
        result = test_inventory.addLaptop("L001", "Test Laptop 1", "WINXP")
        result = test_inventory.addLaptop("L002", "Test Laptop 2", "MACOS")
    ...
    def test_view_laptop_only_available(self): #all of these test case added to test_US_01.py
        test_inventory = Inventory()
        result = test_inventory.addLaptop("L001", "Test Laptop 1", "WINXP")
        result = test_inventory.addLaptop("L002", "Test Laptop 2", "MACOS")
